...
This directory stores software/firmware developments addressed to manage layout items. The directory organizes its information in a directory structure with these levels:
  ...
  1.- A first level based on the litem network technology (dcc, 802.11.4, ble, zigbee, wifi, ...)
  2.- A second level based on the litem hardware, whenever that feature determined different software developments.
